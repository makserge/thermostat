...
#define WM_STRINGS_FILE "wm_strings_en_custom.h" // this includes constants as dependency
#endif
...
class WiFiManager
{
  public:
    ...
    void          setCustomMenuHTML(String html);
  ...
  protected:
    ...
    String   _customMenuHTML         = ""; // store custom head element html from user inside <>
